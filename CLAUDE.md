...
**GraphQL Generation**: Uses [Rumble](https://github.com/m1212e/rumble) (`@m1212e/rumble`), a custom glue package that generates GraphQL schemas and resolvers directly from Drizzle ORM definitions with built-in ability-based access control. The client will be re generated by running the dev server and then requesting /api/graphql which triggers the Rumble codegen while running.
