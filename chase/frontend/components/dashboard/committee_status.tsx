...
export default function CommitteeStatusWidget({ currentDebateStep, nextDebateStep } : { currentDebateStep: string; nextDebateStep: string | undefined; }) {
    ...
    <>
      <WidgetTemplate cardTitle="Stand der Debatte">
        <div className="flex flex-col gap-1">
          <div
            className="flex flex-row bg-dmun text-white rounded-md p-2 gap-4 border border-black shadow-md"
          >
