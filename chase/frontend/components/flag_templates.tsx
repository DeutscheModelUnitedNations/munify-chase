...
export function SmallFlag ({ countryCode, showNameOnHover = false }: { countryCode: CountryCode, showNameOnHover?: boolean }) {
  ...
  return (
    ...
    >
      ...
      {isHovered && showNameOnHover && (
        <div className="bg-dmun text-white text-xs rounded-md shadow-xl p-2 absolute mt-2">
