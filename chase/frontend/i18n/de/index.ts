...
const de = {
  ...
  resolutionEditor: {
    ...
    editor: {
      ...
      PLACEHOLDER: "Füge hier den Absatztext ein ...",
      INVALID_OPERATOR: "Ungültiger Operator",
      INVALID_OPERATOR_DETAILS: "Der Absatz enthält einen ungültigen Operator. Entweder ist der Operator nicht vollständig oder nicht korrekt markiert oder der Operator ist nicht gültig.",
      MISSING_OPERATOR: "Operator fehlt",
      MISSING_OPERATOR_DETAILS: "Der Absatz muss einen gültigen Operator enthalten, welcher als solcher markiert sein muss.",
      VALID_OPERATOR: "Gültiger Operator vorhanden",
      VALID_OPERATOR_DETAILS: "Der Absatz enthält einen gültigen Operator.",
      SAVE_CLAUSE: "Speichern",
      DELETE_CLAUSE: "Absatz löschen",
    },
  },
