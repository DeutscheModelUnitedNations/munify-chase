...
const en = {
  ...
  resolutionEditor: {
    ...
    editor: {
      ...
      PLACEHOLDER: "Insert your clause here ...",
      INVALID_OPERATOR: "Invalid Operator",
      INVALID_OPERATOR_DETAILS: "The paragraph contains an invalid operator. Either the operator is not complete or not marked correctly or the operator is not valid.",
      MISSING_OPERATOR: "Missing Operator",
      MISSING_OPERATOR_DETAILS: "The paragraph must contain a valid operator, which must be marked as such.",
      VALID_OPERATOR: "Valid Operator",
      VALID_OPERATOR_DETAILS: "The paragraph contains a valid operator.",
      SAVE_CLAUSE: "Save",
