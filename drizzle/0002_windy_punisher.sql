...
ALTER TABLE "committee_topic_changed_timestamp" ADD CONSTRAINT "committee_topic_changed_timestamp_agenda_item_id_agenda_item_id_fk" FOREIGN KEY ("agenda_item_id") REFERENCES "public"."agenda_item"("id") ON DELETE cascade ON UPDATE no action;