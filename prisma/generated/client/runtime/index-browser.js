...
h.minus = h.sub = function (e) {
  ...
  if (
    ((i = A(e.e / m)), (c = A(this.e / m)), (f = f.slice()), (s = c - i), s)
  ) {
    for (
      a = s < 0,
        a
...
h.plus = h.add = function (e) {
  ...
  if (
    ((s = A(this.e / m)), (t = A(e.e / m)), (f = f.slice()), (r = s - t), r)
  ) {
    for (
      r < 0
        ? ((i = f), (r = -r), (o = c.length))
...
function B(e, n) {
  ...
  if (N.s < 0 || !_ || !_[0] || (!N.e && _[0] == 1 && _.length == 1))
    return new C(_ && !_[0] ? -1 / 0 : N.s != 1 ? Number.NaN : _ ? 0 : N);
  if (
    (n == null ? ((w = !1), (c = E)) : (c = n),
    (C.precision = c += v),
    (i = O(_)),
