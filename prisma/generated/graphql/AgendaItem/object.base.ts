...
export const AgendaItemObject = definePrismaObject("AgendaItem", {
  ...
  fields: (t) => ({
    ...
    speakerLists: t.relation(
      "speakerLists",
      AgendaItemSpeakerListsFieldObject(t),
    ),
...
export const AgendaItemCommitteeFieldObject = defineRelationObject(
  "AgendaItem",
  "committee",
  {
    description: undefined,
...
export const AgendaItemCommitteeIdFieldObject = defineFieldObject(
  "AgendaItem",
  {
    type: "String",
    description: undefined,
...
export const AgendaItemDescriptionFieldObject = defineFieldObject(
  "AgendaItem",
  {
    type: "String",
    description: undefined,
...
export const AgendaItemSpeakerListsFieldObject = defineRelationFunction(
  "AgendaItem",
  (t) =>
