...
export const findManyAgendaItemQueryArgs = builder.args((t) => ({
...
export const findManyAgendaItemQueryObject = defineQueryFunction((t) =>
  defineQueryPrismaObject({
    type: ['AgendaItem'],
    nullable: false,
    args: findManyAgendaItemQueryArgs,
...
export const findManyAgendaItemQuery = defineQuery((t) => ({
  findManyAgendaItem: t.prismaField(findManyAgendaItemQueryObject(t)),
}));
