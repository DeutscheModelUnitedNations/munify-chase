...
export const CommitteeObject = definePrismaObject("Committee", {
  ...
  fields: (t) => ({
    ...
    subCommittees: t.relation(
      "subCommittees",
      CommitteeSubCommitteesFieldObject(t),
    ),
...
export const CommitteeConferenceFieldObject = defineRelationObject(
  "Committee",
  "conference",
  {
    description: undefined,
...
export const CommitteeMembersFieldObject = defineRelationFunction(
  "Committee",
  (t) =>
...
export const CommitteeParentFieldObject = defineRelationObject(
  "Committee",
  "parent",
  {
    description: undefined,
...
export const CommitteeSubCommitteesFieldObject = defineRelationFunction(
  "Committee",
  (t) =>
...
export const CommitteeMessagesFieldObject = defineRelationFunction(
  "Committee",
  (t) =>
...
export const CommitteeAgendaItemsFieldObject = defineRelationFunction(
  "Committee",
  (t) =>
...
export const CommitteeWhiteboardContentFieldObject = defineFieldObject(
  "Committee",
  {
    type: "String",
    description: undefined,
...
export const CommitteeStateOfDebateFieldObject = defineFieldObject(
  "Committee",
  {
    type: "String",
    description: undefined,
...
export const CommitteeStatusHeadlineFieldObject = defineFieldObject(
  "Committee",
  {
    type: "String",
    description: undefined,
...
export const CommitteeAllowDelegationsToAddThemselvesToSpeakersListFieldObject =
  defineFieldObject("Committee", {
    type: "Boolean",
    description: undefined,
    nullable: false,
