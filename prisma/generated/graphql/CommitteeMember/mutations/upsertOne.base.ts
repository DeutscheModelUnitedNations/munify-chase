...
export const upsertOneCommitteeMemberMutationObject = defineMutationFunction((t) =>
...
export const upsertOneCommitteeMemberMutation = defineMutation((t) => ({
  upsertOneCommitteeMember: t.prismaField(upsertOneCommitteeMemberMutationObject(t)),
}));
