...
export const CommitteeMemberObject = definePrismaObject('CommitteeMember', {
  description: 'A users membership in a committee, providing them with a role in the committee',
  findUnique: ({ id }) => ({ id }),
  fields: (t) => ({
...
export const CommitteeMemberIdFieldObject = defineFieldObject('CommitteeMember', {
  type: "ID",
...
export const CommitteeMemberCommitteeFieldObject = defineRelationObject('CommitteeMember', 'committee', {
  description: undefined,
  nullable: false,
  args: undefined,
  query: undefined,
...
export const CommitteeMemberCommitteeIdFieldObject = defineFieldObject('CommitteeMember', {
  type: "String",
  description: undefined,
  nullable: false,
...
export const CommitteeMemberUserFieldObject = defineRelationObject('CommitteeMember', 'user', {
  description: undefined,
  nullable: true,
  args: undefined,
  query: undefined,
...
export const CommitteeMemberUserIdFieldObject = defineFieldObject('CommitteeMember', {
  type: "String",
  description: undefined,
  nullable: true,
...
export const CommitteeMemberSpeakerListsFieldObject = defineRelationFunction('CommitteeMember', (t) =>
...
export const CommitteeMemberDelegationFieldObject = defineRelationObject('CommitteeMember', 'delegation', {
  description: undefined,
  nullable: true,
  args: undefined,
  query: undefined,
...
export const CommitteeMemberDelegationIdFieldObject = defineFieldObject('CommitteeMember', {
  type: "String",
  description: undefined,
  nullable: true,
...
export const CommitteeMemberPresenceFieldObject = defineFieldObject('CommitteeMember', {
