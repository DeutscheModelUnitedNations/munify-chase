...
export const ConferencePressWebsiteFieldObject = defineFieldObject(
  "Conference",
  {
    type: "String",
    description: undefined,
...
export const ConferenceFeedbackWebsiteFieldObject = defineFieldObject(
  "Conference",
  {
    type: "String",
    description: undefined,
...
export const ConferenceDelegationsFieldObject = defineRelationFunction(
  "Conference",
  (t) =>
...
export const ConferenceMembersFieldObject = defineRelationFunction(
  "Conference",
  (t) =>
...
export const ConferenceCommitteesFieldObject = defineRelationFunction(
  "Conference",
  (t) =>
