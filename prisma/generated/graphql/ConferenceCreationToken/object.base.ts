...
export const ConferenceCreationTokenObject = definePrismaObject('ConferenceCreationToken', {
...
export const ConferenceCreationTokenTokenFieldObject = defineFieldObject('ConferenceCreationToken', {
  type: "ID",
