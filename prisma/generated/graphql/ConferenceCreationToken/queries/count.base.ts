...
export const countConferenceCreationTokenQueryObject = defineQueryFunction((t) =>
  defineQueryObject({
    type: 'Int',
    nullable: false,
...
export const countConferenceCreationTokenQuery = defineQuery((t) => ({
  countConferenceCreationToken: t.field(countConferenceCreationTokenQueryObject(t)),
}));
