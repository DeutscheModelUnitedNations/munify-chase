...
export const findFirstConferenceCreationTokenQueryObject = defineQueryFunction(
  (t) =>
    defineQueryPrismaObject({
...
export const findFirstConferenceCreationTokenQuery = defineQuery((t) => ({
  findFirstConferenceCreationToken: t.prismaField(
    findFirstConferenceCreationTokenQueryObject(t),
  ),
}));
