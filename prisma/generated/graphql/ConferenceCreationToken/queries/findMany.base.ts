...
export const findManyConferenceCreationTokenQueryObject = defineQueryFunction((t) =>
...
export const findManyConferenceCreationTokenQuery = defineQuery((t) => ({
  findManyConferenceCreationToken: t.prismaField(findManyConferenceCreationTokenQueryObject(t)),
}));
