...
export const updateManyConferenceMemberMutationArgs = builder.args((t) => ({
  ...
  data: t.field({
    type: Inputs.ConferenceMemberUpdateManyMutationInput,
    required: true,
  }),
}));

export const updateManyConferenceMemberMutationObject = defineMutationFunction(
  (t) =>
    defineMutationObject({
      type: BatchPayload,
      nullable: false,
      ...
      resolve: async (_root, args, _context, _info) =>
        await db.conferenceMember.updateMany({
...
export const updateManyConferenceMemberMutation = defineMutation((t) => ({
  updateManyConferenceMember: t.field(
    updateManyConferenceMemberMutationObject(t),
  ),
}));
