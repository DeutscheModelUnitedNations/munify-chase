...
export const upsertOneConferenceMemberMutationObject = defineMutationFunction((t) =>
...
export const upsertOneConferenceMemberMutation = defineMutation((t) => ({
  upsertOneConferenceMember: t.prismaField(upsertOneConferenceMemberMutationObject(t)),
}));
