...
export const DelegationConferenceFieldObject = defineRelationObject(
  "Delegation",
  "conference",
  {
    description: undefined,
...
export const DelegationConferenceIdFieldObject = defineFieldObject(
  "Delegation",
  {
    type: "String",
    description: undefined,
...
export const DelegationNationFieldObject = defineRelationObject(
  "Delegation",
  "nation",
  {
    description: undefined,
...
export const DelegationMembersFieldObject = defineRelationFunction(
  "Delegation",
  (t) =>
