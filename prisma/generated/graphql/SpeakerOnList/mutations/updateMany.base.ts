...
export const updateManySpeakerOnListMutationArgs = builder.args((t) => ({
  ...
  data: t.field({
    type: Inputs.SpeakerOnListUpdateManyMutationInput,
    required: true,
  }),
}));

export const updateManySpeakerOnListMutationObject = defineMutationFunction(
  (t) =>
    defineMutationObject({
      type: BatchPayload,
      nullable: false,
      ...
      resolve: async (_root, args, _context, _info) =>
        await db.speakerOnList.updateMany({
