...
export const updateManySpeakersListMutationArgs = builder.args((t) => ({
      ...
      data: t.field({ type: Inputs.SpeakersListUpdateManyMutationInput, required: true }),
    }))

export const updateManySpeakersListMutationObject = defineMutationFunction((t) =>
  defineMutationObject({
    type: BatchPayload,
    nullable: false,
    args: updateManySpeakersListMutationArgs,
    resolve: async (_root, args, _context, _info) =>
      await db.speakersList.updateMany({ where: args.where || undefined, data: args.data }),
  }),
);
