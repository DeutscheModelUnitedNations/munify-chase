...
export const SpeakersListAgendaItemFieldObject = defineRelationObject('SpeakersList', 'agendaItem', {
  description: undefined,
  nullable: false,
  args: undefined,
  query: undefined,
...
export const SpeakersListAgendaItemIdFieldObject = defineFieldObject('SpeakersList', {
  type: "String",
  description: undefined,
  nullable: false,
...
export const SpeakersListSpeakersFieldObject = defineRelationFunction('SpeakersList', (t) =>
...
export const SpeakersListSpeakingTimeFieldObject = defineFieldObject('SpeakersList', {
  type: "Int",
...
export const SpeakersListTimeLeftFieldObject = defineFieldObject('SpeakersList', {
  type: "Int",
  description: undefined,
  nullable: true,
...
export const SpeakersListStartTimestampFieldObject = defineFieldObject('SpeakersList', {
...
export const SpeakersListIsClosedFieldObject = defineFieldObject('SpeakersList', {
  type: "Boolean",
  description: undefined,
  nullable: false,
