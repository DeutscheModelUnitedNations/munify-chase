...
export const UserObject = definePrismaObject('User', {
  ...
  fields: (t) => ({
    ...
    conferenceMemberships: t.relation('conferenceMemberships', UserConferenceMembershipsFieldObject(t)),
    committeeMemberships: t.relation('committeeMemberships', UserCommitteeMembershipsFieldObject(t)),
...
export const UserConferenceMembershipsFieldObject = defineRelationFunction('User', (t) =>
...
export const UserCommitteeMembershipsFieldObject = defineRelationFunction('User', (t) =>
