...
import CommitteeTable from "@/app/components/admin/structure/committee_table";
import AddCommitteeDialog from "@/app/components/admin/structure/add_committee_dialog";
