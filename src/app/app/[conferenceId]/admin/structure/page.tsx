...
import CommitteeTable from "@/frontend/components/admin/structure/committee_table";
import AddCommitteeDialog from "@/frontend/components/admin/structure/add_committee_dialog";
