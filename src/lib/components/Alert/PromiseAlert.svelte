...
<AlertDialog.Root bind:open>
  <AlertDialog.Portal>
    ...
    {#if open}
      <div
        class="card fixed top-1/2 left-1/2 z-40 m-4 w-full max-w-xl -translate-x-1/2 -translate-y-1/2 bg-base-100 shadow-md"
        ...
        <AlertDialog.Content>
          <div class="card-body flex w-full flex-col items-center justify-center gap-6">
            ...
            <div class="modal-actions flex w-full gap-2">
              <AlertDialog.Cancel onclick={$alertDialogStore?.onClose} class="btn flex-1 btn-lg">
              ...
              <AlertDialog.Action
                ...
                class="btn btn-{$alertDialogStore?.confirmColor ?? 'primary'} flex-1 btn-lg"
              >
