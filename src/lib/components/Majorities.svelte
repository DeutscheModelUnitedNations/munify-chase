<script lang="ts">
  ...
  const { totalPresent, simpleMajority, twoThirdsMajority, paperSupportThreshold }: Props =
    $props();
</script>
...
{#snippet Card(cardData: {
  ...
  <div class="card h-full flex-1 flex-col items-center justify-center bg-base-200 p-4 shadow-sm">
