/**
 * Platform adapter — bridges Tauri native APIs and browser fallbacks.
 * All cross-platform actions (open external URL, open presentation window,
 * toggle fullscreen) go through here so call sites stay environment-agnostic.
 */
